...
while(rs.next())
       {
    judge1 = rs.getFloat("judge1");
    judge2 = rs.getFloat("judge2");
    judge3 = rs.getFloat("judge3");
    judge4 = rs.getFloat("judge4");
    judge5 = rs.getFloat("judge5");
    
}
if(judge1>Float.parseFloat(max)){judge1=Float.parseFloat(max);}
if(judge2>Float.parseFloat(max)){judge2=Float.parseFloat(max);}
if(judge3>Float.parseFloat(max)){judge3=Float.parseFloat(max);}
if(judge4>Float.parseFloat(max)){judge4=Float.parseFloat(max);}
if(judge5>Float.parseFloat(max)){judge5=Float.parseFloat(max);}
