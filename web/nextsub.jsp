...
String update = "update round set round = round+1";
statement.executeUpdate(update);

String del = "delete from active_participant";
...
String pid = "select min(pid) from active_participant";
out.print(pid);
...
String updateshift = "update active_participant set pid = pid - "+pid+"+1";
statement.executeUpdate(updateshift);
